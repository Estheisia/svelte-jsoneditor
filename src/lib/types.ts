...
export type TranslationKey = {
  ...
  original: string
  preview: string
  collapseValidationErrors: string
  cancelRepair: string
  scrollToError: string
  applyFixedJson: string
  jsonIsValidNow: string
  repairInvalidJson: string
  cannotParseJson: string
  toggleFullScreen: string
  copyingAndPasting: string
  copyPathToClipboard: string
  limitedToItems: string
  expandOrCollapseArray: string
  expandOrCollapseObject: string
  time: string
  containsInvalidData: string
  validationTurnedOff: string
  emptyDocumentTitle: string
  createObject: string
  createArray: string
  collapsing: string
  cancelEditingPath: string
  editSelectedPath: string
  navigationBar: string
  columnsSampledWarning: string
  openColorPicker: string
  colorValue: string
  toggleBooleanValue: string
  booleanValue: string
  ctrlClickToOpenUrl: string
}
